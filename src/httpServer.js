...
exports.initServer = (state, cb) => {
    ...
    app.put("/api/server_settings/save", (req, res) => {
        ...
        state.server_config.virtual_ip_address_ipv4 = req.body.virtual_ip_address_ipv4;
        state.server_config.virtual_ip_address_ipv6 = req.body.virtual_ip_address_ipv6;
        ...
        state.server_config.core_dns = req.body.core_dns;
    ...
    app.get("/api/download/:id", (req, res) => {
        ...
        nunjucks.render(
            "templates/config_client.njk", {
                ...
                virtual_ip_address_ipv4: state.server_config.virtual_ip_address_ipv4,
                virtual_ip_address_ipv6: state.server_config.virtual_ip_address_ipv6,
            },
            (err, renderedConfig) => {
                if (err) {
    ...
    app.post("/api/switchtrafficmode", (req, res) => {
        if (!state.server_config.handleUFW) {
            res.status(200).send({
                msg: "OK",
            });
            return;
